...
const Eyes = () => {
  ...
  // Left side hearts (floating up from left edge)
  ...
  // Right side hearts (floating up from right edge)
  ...
  // Center hearts (floating up randomly)
        ...
        {eyeSketches.length > 1 && (
          <motion.div
            style={{
              ...
              maxHeight: '350px',
              backgroundImage: `url(${
                eyeSketches[(currentIndex - 1 + eyeSketches.length) % eyeSketches.length]?.image
              })`,
              backgroundSize: 'cover',
              backgroundPosition: 'center',
              borderRadius: '15px',
        ...
        {eyeSketches.length > 1 && (
          <motion.div
            style={{
              ...
              maxHeight: '350px',
              backgroundImage: `url(${
                eyeSketches[(currentIndex + 1) % eyeSketches.length]?.image
              })`,
              backgroundSize: 'cover',
              backgroundPosition: 'center',
              borderRadius: '15px',
      ...
      <div style={{
        ...
        <motion.button
          onClick={() => setCurrentIndex((prev) => 
            (prev - 1 + eyeSketches.length) % eyeSketches.length
          )}
